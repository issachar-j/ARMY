const simpleModalCode = `import { useState } from "react";// @mui material components
...
import MKTypography from "components/MKTypography";function SimpleModal() {
  const [show, setShow] = useState(false);
  const toggleModal = () => setShow(!show);  return (
